...
public class TinyDB {
    ...
    public ArrayList<Items> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Items> playerList =  new ArrayList<Items>();

        for(String jObjString : objStrings){
            Items player  = gson.fromJson(jObjString,  Items.class);
